...
" t)
 ...
 '(dashboard-items (quote ((recents . 15) (projects . 5) (agenda . 5))) t)
 ...
 '(git-gutter:update-hooks (quote (after-save-hook after-revert-hook)) t)
 '(google-translate-translation-directions-alist (quote (("ja" . "en") ("en" . "ja"))) t)
 ...
 '(langtool-java-user-arguments (quote ("-Dfile.encoding=UTF-8")) t)
 ...
 '(lsp-enable-completion-at-point nil t)
 '(lsp-prefer-flymake nil t)
 '(lsp-print-io nil t)
 '(lsp-print-performance nil t)
 '(lsp-response-timeout 5 t)
 '(lsp-trace nil t)
 '(migemo-coding-system (quote utf-8-unix) t)
    ...
    (("o" "At the office" tags-todo "@office"
      ((org-agenda-overriding-header "Office")
       (org-agenda-skip-function
        (function my:org-agenda-skip-all-sibling-but-first)))))))
 ...
 '(shackle-default-rule (quote (:select t)) t)
 '(shackle-rules (quote ((compilation-mode :align t :size 0.4))) t)
