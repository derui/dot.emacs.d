...
#+begin_src emacs-lisp
  (leaf *face
    ...
    :config
    (set-face-attribute 'bookmark-face nil :foreground nil :background nil))
#+end_src
        ...
        (defun my:org-get-keyword (keyword &optional buffer)
          ...
          (with-current-buffer (or buffer (current-buffer))
            (let ((el (org-element-map
                          ...
                          'keyword
                        (lambda (el) (when (string-match keyword (org-element-property :key el)) el)) nil 'first-match)))
              (when el
...
#+begin_src emacs-lisp
  (leaf avy
    :straight t
    :config
    (add-to-list 'avy-styles-alist '(avy-goto-char-timer . pre)))
#+end_src
...
#+begin_src emacs-lisp
  (leaf evil-cleverparens
    :straight t
    :after (elisp-mode lisp-mode scheme-mode evil)
    :hook
  ...
  (leaf *orderless-migemo-config
    ...
    (setq completion-category-overrides
          '((command (styles orderless-default-style))
            ...
            (file (styles . (partial_completion orderless-migemo-style)))
