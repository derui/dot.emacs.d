...
#+begin_src emacs-lisp
  (leaf *persp-transient
    :after (transient)
    :config
    ;; suppress warnings after Emacs 28. I don't want to set prefix key on global.
...
#+begin_src emacs-lisp
  (leaf diff-hl
    ...
    (text-mode-hook . diff-hl-flydiff-mode)
    :config
...
#+begin_src emacs-lisp
  (leaf eglot
    ...
    :hook
    (eldoc-managed-mode-hook . eldox-box-hover-mode)
    :config
