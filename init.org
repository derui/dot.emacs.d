...
#+begin_src emacs-lisp
  (leaf *global-user
    ...
    (define-key my:global-user-mode-keymap (kbd "ca") #'consult-apropos)
...
#+begin_src emacs-lisp
  ...
  (leaf meow :straight t :require t
    :bind
    ((:meow-normal-state-keymap
      ("C-j" . (lambda ()
                 ...
                 (meow-append)))))
    :hook
    (meow-insert-exit-hook . (lambda nil (if skk-mode (skk-latin-mode-on))))
    ...
    (defun meow-setup ()
      ...
      (meow-normal-define-key
       ...
       '("C-w c" . ace-delete-window)
       '("C-w o" . ace-delete-other-windows)
       '("<escape>" . ignore)))
...
*** shackle
特定のmodeが表示されているwindowのサイズを強制的に変更する。エラーとかコンパイルのメッセージとか、そこまで主張しなくていいやつを押し込む用途で使う。
...
#+begin_src emacs-lisp
  (leaf lsp-mode
    ...
    (:lsp-mode-map
     ("M-<tab>" . yas-expand)
     ("C-c r" . lsp-rename)
     ("C-c C-k" . lsp-signature-activate))
    :preface
