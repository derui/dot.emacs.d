...
#+begin_src emacs-lisp
  (leaf ryo-modal
    ...
    (ryo-modal-keys
     ...
     ("V" beginning-of-line :then '(set-mark end-of-line))
    ...
    (ryo-modal-keys
     ("d"
      (("w" puni-mark-sexp-at-point :then (puni-kill-active-region))
       ("W" mark-word :then (puni-kill-active-region))
