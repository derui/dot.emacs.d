...
#+begin_src emacs-lisp
  ...
  "
    ...
    (:with-mode dired-mode
      ;; wdiredを有効にする
      (:hook wdired-change-to-wdired-mode)
      (:bind
...
#+begin_src emacs-lisp
  (setup recentf
    ...
    (:hook-into emacs-after-init-hook))
#+end_src
*** dabbrev
#+begin_src emacs-lisp
  (setup dabbrev
...
#+begin_src emacs-lisp
  ...
  ;;         (selected-minor-mode -1))))
  ;; 
  ;;   (:hook my:ryo-modal-mode-hook)
  ;;   (setq ryo-modal-cursor-color nil)
  ;;   (setq ryo-modal-cursor-type 'box)
  ;;   
  ;;   (defun my:ryo-modal-setup ()
  ;;     "initialize ryo-modal"
  ...
  ;; 
  ;;   (:with-function my:ryo-modal-setup
...
#+begin_src emacs-lisp
  (leaf treesit
    ...
    (leaf treesit-auto
      ...
      :hook
      (emacs-after-init-hook . global-treeset-auto-mode)
      :config
