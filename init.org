      ...
      (transient-define-prefix my:structuring-transient ()
        ...
        [
         ...
         ["Move with structuring"
          ("h" "Backward sexp" puni-backward-sexp-or-up-list :transient t)
          ("j" "Next sexp" puni-forward-sexp :transient t)
          ("k" "Backward sexp" puni-backward-sexp :transient t)
          ("l" "Forward sexp" puni-forward-sexp-or-up-list :transient t)
          ("J" "End of sexp" puni-end-of-sexp :transient t)
          ("K" "Beginning of sexp" puni-beginning-of-sexp :transient t)
          ("," "Backward punct" puni-syntactic-backward-punct :transient t)
          ("." "Forward punct" puni-syntactic-forward-punct :transient t)
          ]
         ["Basic editing"
          ("C-k" "Kill line balanced" puni-kill-line :transient t)
    ...
    (defun my:modalka-setup ()
      ...
      (define-key modalka-mode-map (kbd ",")
                  (let ((keymap (make-sparse-keymap)))
                    ...
                    (define-key keymap (kbd "r") #'my:structuring-transient)
                    keymap))
...
#+begin_src emacs-lisp
  (setup orderless
    (:straight orderless)
    (:with-function orderless-filter
      (:autoload-this)))
