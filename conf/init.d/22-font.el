    ...
    (cond
     ...
     ((eq window-system 'x)
      (let* ((size my:font-size)
        ...
        (create-fontset-from-ascii-font font nil "myfont")
        (set-fontset-font "fontset-myfont"'unicode jp-fontspec nil 'append)
        (add-to-list 'default-frame-alist '(font . "fontset-myfont"))
        (set-face-attribute 'default nil :family "myfont" :height h)
